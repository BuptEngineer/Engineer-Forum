...
<html>
  <head>
	...
	<link rel="stylesheet" type="text/css" href="jsps/css/personal/myAnswer.css">
	<!-- 遮罩层start -->
	<script>
			...
			<div class="widget-box">
			  ...
			  <div class="widget-content nopadding">
				<ul class="recent-posts">
				  <c:forEach items="${answers}" var="a" varStatus="index">
						<li class="routeRow">
						...
						<div class="article-post">
						  ...
						  <p><a href="javascript:void(0)">问题名: ${a.a_id}</a></p>
						  <p><a href="javascript:void(0)">问题简介:  ${a.a_content}</a></p>
						  <span class="user-info"> 更新时间:${a.a_time} </span>
						</div>					
					  	</li>
					</c:forEach>
				</ul>
