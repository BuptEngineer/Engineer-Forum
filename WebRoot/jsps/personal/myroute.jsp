...
<html>
  <head>
	...
	<link rel="stylesheet" type="text/css" href="jsps/css/personal/myroute.css">
	<!-- 遮罩层start -->
	<script>
			...
			<div class="widget-box">
			  ...
			  <div class="widget-content nopadding">
				<ul class="recent-posts">
				  <c:forEach items="${routes}" var="r" varStatus="index">
						<li class="routeRow">
						...
						<div class="article-post">
						  ...
						  <p><a href="<c:url value='/RouteServlet?method=find&rt_id=${r.rt_id }'/>">路线名: ${r.rt_name}</a></p>
						  <p><a href="<c:url value='/RouteServlet?method=find&rt_id=${r.rt_id }'/>">路线简介:  ${r.rt_desc}</a></p>
						  <span class="user-info"> 更新时间:${r.rt_time} </span>
						</div>					
					  	</li>
					</c:forEach>
				</ul>
